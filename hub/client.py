...
# ------------------------------------------------------------------
_SEED_CATALOG = [
    {"id": "f523a78b0e2b4c6a8719ef05a165ab4e", "name": "Zambia Health Facilities (NSDI)",
    ...
    {"id": "0c748bfc945c49ce81d07034b1560a68", "name": "Zambia Education Facilities",
    ...
    {"id": "d27357c640394f11943316e36cebaba3", "name": "Zambia Administrative Districts",
    ...
    {"id": "a0293a6e84c143298227518eb3418d23", "name": "Zambia Settlement Names",
    ...
    {"id": "8f73c42ed3884256904ae12440fae558", "name": "Zambia Points of Interest",
     "description": (
    ...
    {"id": "3fb6aa51dc9a4df1a1b7f4e48df5a374", "name": "Zambia Risk Indicators by District & Province",
    ...
    {"id": "e31efc4a98774524a93e2eb838dd8fc3", "name": "Zambia Provincial Boundaries (Admin 1)",
    ...
    {"id": "e31efc4a98774524a93e2eb838dd8fc3", "name": "Zambia District Boundaries (Admin 2)",
    ...
    {"id": "e31efc4a98774524a93e2eb838dd8fc3", "name": "Zambia National Boundary (Admin 0)",
    ...
    {"id": "c17e97e2947040e1a0ea547a083533ad", "name": "Zambia Onshore Aquaculture Suitability Zones",
    ...
    {"id": "a235535d12314d5b87122c8ee4aac7a2", "name": "Zambia Lake Kariba Cage Aquaculture Suitability Zones",
    ...
    {"id": "4c90a57457fb4e1cb90888d0d394fb78", "name": "Zambia Agriculture Blocks and Camps",
    ...
    {"id": "51ac30a1d6454db18a5dbba03524724d", "name": "Zambia Constituencies",
    ...
    {"id": "fc6fc1b222fd400abfdb1158dc27e3bc", "name": "Zambia National Parks and Game Management Areas",
    ...
    {"id": "7b3cf3848be947739d4cdf4e7c836f4c", "name": "Zambia Forest Reserves",
    ...
    {"id": "fbff7250ebc94120a1f9d8e332317bbe", "name": "Zambia Erosion Hazard Classification",
    ...
    {"id": "d50e882d14d8454cb15c7467fa050205", "name": "Zambia Soil Type Classification",
    ...
    {"id": "068949f7d4d841f3bc6b485a0a44f3f0", "name": "Zambia Settlement Extents",
    ...
    {"id": "0c748bfc945c49ce81d07034b1560a68", "name": "Zambia NSDI Operational Schools",
    ...
    {"id": "f523a78b0e2b4c6a8719ef05a165ab4e", "name": "Zambia NSDI Operational Health Facilities",
    ...
    {"id": "e216143d86bb4cf786ebd0354501e41a", "name": "Zambia Distribution MV Overhead Lines",
     "description": "Medium-voltage (MV) overhead electricity distribution lines across Zambia. Shows the grid distribution network above ground. Useful for electrification coverage and grid extension planning.",
     "url": "https://services.arcgis.com/iQ1dY19aHwbSDYIF/arcgis/rest/services/Zambia_Distribution_MV_Overhead_Line/FeatureServer/0",
     "tags": ["power", "electricity", "mv lines", "medium voltage", "distribution", "grid", "energy", "infrastructure", "zambia", "zmb"], "fields": [], "geometry_type": "LineString", "extent": {}, "modified": ""},
    {"id": "d7c050048fe5466799388598df72f51e", "name": "Zambia High Voltage (HV) Transmission Lines",
     "description": "High-voltage (HV) electricity transmission lines across Zambia. Represents the national backbone grid for long-distance power transmission.",
     "url": "https://services.arcgis.com/iQ1dY19aHwbSDYIF/arcgis/rest/services/Zambia_Distributed_HV_Lines/FeatureServer/0",
     "tags": ["power", "electricity", "hv lines", "high voltage", "transmission", "grid", "energy", "infrastructure", "zambia", "zmb"], "fields": [], "geometry_type": "LineString", "extent": {}, "modified": ""},
    {"id": "a871cc69630c40f194b253c692cf73e6", "name": "Zambia Distribution MV Underground Lines",
     "description": "Medium-voltage (MV) underground electricity distribution lines across Zambia. Shows the buried grid infrastructure, typically in urban areas.",
     "url": "https://services.arcgis.com/iQ1dY19aHwbSDYIF/arcgis/rest/services/Zambia_Distribution_MV_Underground_Line/FeatureServer/0",
     "tags": ["power", "electricity", "mv lines", "medium voltage", "underground", "distribution", "grid", "urban", "energy", "zambia", "zmb"], "fields": [], "geometry_type": "LineString", "extent": {}, "modified": ""},
