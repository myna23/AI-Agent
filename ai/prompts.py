...
def chatbot_system_prompt() -> str:
    return (
        ...
        "- When a '_note' field is present in the records saying data could not be retrieved, "
        "respond with ONLY: the live server is unavailable and the user should try again later. "
        "Do NOT add context about the region, typical patterns, planning insights, or what the "
        "data 'would likely show'. Say nothing beyond the server status.\n"
