...
def process_question(question: str):
    ...
    # --- CHAT (default) ---
        ...
        with st.chat_message("assistant"):
            ...
            # Maps every seed-catalog ID → its verified Hub dataset page URL.
            # IDs ending _0 needed the layer suffix; bare IDs work without it.
            # b55592d29ac145ad824bc8531ab75224 (Marketplaces) has no Hub page — omitted.
            _HUB_CATALOG_URLS = {
                ...
                # 8f73c42ed3884256904ae12440fae558 (POI v1.0) — Hub page broken; use arcgis.com fallback
            ...
            if not _ai_error and _valid_id:
                _ds_hub_url = _HUB_CATALOG_URLS.get(
                    _ds_item_id,
                    f"https://www.arcgis.com/home/item.html?id={_ds_item_id}",
                )
            elif not _ai_error:
